		...
		<div class="wrap bsm-wrap">
			...
			<div class="bsm-panel" id="bsm-edit-panel" style="display:none;">
				...
				<div class="bsm-fill-box">
					<strong>Optional — fill from a published blog post:</strong>
					<div class="bsm-fill-row">
						<select id="bsm-fill-post-type"></select>
						<select id="bsm-fill-post-search" style="width:60%;"></select>
					</div>
					<p class="description">This overwrites only the fields it can confidently map (title, excerpt, featured image, link). Everything else is left as-is — edit it by hand below.</p>
				</div>
